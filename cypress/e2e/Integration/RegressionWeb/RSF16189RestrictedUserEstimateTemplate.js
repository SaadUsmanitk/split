...
describe('RestrictedUserSaveEstimateTemplate', () => {
  it('Restricted user should not be able to add estimate folder', { tags: 'Regression' }, () => {
    ...
    customerestimates.restrictedUserEstimateTemplate();
  });
  Cypress.on(
    'uncaught:exception',
    (_err, _runnable) =>
