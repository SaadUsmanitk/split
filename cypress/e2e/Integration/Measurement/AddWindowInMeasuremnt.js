  ...
  it('Add New Measurement', () => {
    ...
    cy.fixture('measurements').then((addmeasurement) => {
      measurement.windowMeasurement(
        addmeasurement.wname,
        addmeasurement.wlocation,
        addmeasurement.wquantity,
        addmeasurement.wmeasurementType,
        addmeasurement.wlevel,
        addmeasurement.wwidth,
        addmeasurement.wheight
      );
    });
    measurement.windowSave();
