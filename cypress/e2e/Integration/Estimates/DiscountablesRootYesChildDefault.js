...
describe('DiscountableRootYesChildDefault', () => {
  it('Adding a child product with discountable default under root yes', { tags: 'Smoke' }, () => {
    ...
    customerestimates.yesDiscountableDefaultYesProductNameFromFixture();
    customerestimates.yesDiscountableDefaultChildProductPriceAssertion();
  });
  Cypress.on(
    'uncaught:exception',
    (_err, _runnable) =>
