...
describe('DiscountableRootDefaultChildDefault', { tags: 'Smoke' }, () => {
  it('Adding a child product with discountable default under root default', () => {
    ...
    customerestimates.defaultDiscountableChildDefaultProductNameFromFixture();
    customerestimates.defaultDiscountableChildDefaultProductPriceAssertion();
  });
  Cypress.on(
    'uncaught:exception',
    (_err, _runnable) =>
