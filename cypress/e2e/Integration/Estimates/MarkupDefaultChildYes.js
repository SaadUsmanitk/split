...
describe('ChildMarkupYes', () => {
  it('Adding a child product with markup yes', { tags: 'Smoke' }, () => {
    ...
    customerestimates.defaultMarkupYesChildProductNameFromFixture();
    customerestimates.defaultMarkupProductYesChildPriceAssertion();
  });
  Cypress.on(
    'uncaught:exception',
    (_err, _runnable) =>
