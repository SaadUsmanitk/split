...
describe('DiscountableRootDefaultChildNo', { tags: 'Smoke' }, () => {
  it('Adding a child product with discountable no under root default', () => {
    ...
    customerestimates.defaultDiscountableNoChildProductNameFromFixture();
    customerestimates.defaultDiscountableProductNoChildPriceAssertion();
  });
  Cypress.on(
    'uncaught:exception',
    (_err, _runnable) =>
