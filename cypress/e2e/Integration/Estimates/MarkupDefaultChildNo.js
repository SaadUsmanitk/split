...
describe('ChildMarkupNo', () => {
  it('Adding a child product with markup no', { tags: 'Smoke' }, () => {
    ...
    customerestimates.defaultMarkupNoChildProductNameFromFixture();
    customerestimates.defaultMarkupProductNoChildPriceAssertion();
  });
  Cypress.on(
    'uncaught:exception',
    (_err, _runnable) =>
