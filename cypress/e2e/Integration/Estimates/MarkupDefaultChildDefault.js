...
describe('ChildMarkupDefault', () => {
  it('Adding a child product with markup default', { tags: 'Smoke' }, () => {
    ...
    customerestimates.defaultMarkupDefaultChildProductNameFromFixture();
    customerestimates.defaultMarkupProductDefaultChildPriceAssertion();
  });
  Cypress.on(
    'uncaught:exception',
    (_err, _runnable) =>
