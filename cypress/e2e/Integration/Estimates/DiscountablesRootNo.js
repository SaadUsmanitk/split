...
describe('DiscountableRootNo', () => {
  it('Adding a root product with discountable no', { tags: 'Smoke' }, () => {
    ...
    customerestimates.noDiscountableProductNameFromFixture();
    customerestimates.noDiscountableProductPriceAssertion();
  });
  Cypress.on(
    'uncaught:exception',
    (_err, _runnable) =>
