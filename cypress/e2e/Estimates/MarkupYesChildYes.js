...
describe('MarkupYesChildYes', () => {
  it('Adding a root product with markup yes', { tags: 'Smoke' }, () => {
    ...
    customerestimates.yesMarkupChildYesProductNameFromFixture();
    customerestimates.yesMarkupChildYesProductPriceAssertion();
  });
  Cypress.on(
    'uncaught:exception',
    (_err, _runnable) =>
