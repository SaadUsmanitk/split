...
describe('DiscountableRootNoChildDefault', () => {
  it('Adding a child product with discountable default under root no', { tags: 'Smoke' }, () => {
    ...
    customerestimates.noDiscountableDefaultChildProductNameFromFixture();
    customerestimates.noDiscountableDefaultChildProductPriceAssertion();
  });
  Cypress.on(
    'uncaught:exception',
    (_err, _runnable) =>
