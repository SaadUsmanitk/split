...
describe('DiscountableRootYesChildYes', () => {
  it('Adding a child product with discountable yes under root yes', { tags: 'Smoke' }, () => {
    ...
    customerestimates.yesDiscountableChildYesProductNameFromFixture();
    customerestimates.yesDiscountableChildYesProductPriceAssertion();
  });
  Cypress.on(
    'uncaught:exception',
    (_err, _runnable) =>
