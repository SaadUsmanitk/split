...
describe('DiscountableRootNoChildNo', () => {
  it('Adding a child product with discountable no under root no', { tags: 'Smoke' }, () => {
    ...
    customerestimates.noDiscountableNoChildProductNameFromFixture();
    customerestimates.noDiscountableNoChildProductPriceAssertion();
  });
  Cypress.on(
    'uncaught:exception',
    (_err, _runnable) =>
