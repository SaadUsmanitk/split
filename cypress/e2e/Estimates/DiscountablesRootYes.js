...
describe('DiscountableRootYes', () => {
  it('Adding a root product with discountable yes', { tags: 'Smoke' }, () => {
    ...
    customerestimates.yesDiscountableProductNameFromFixture();
    customerestimates.yesDiscountableProductPriceAssertion();
  });
  Cypress.on(
    'uncaught:exception',
    (_err, _runnable) =>
