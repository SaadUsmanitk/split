...
describe('MarkupYesChildNo', () => {
  it('Adding a root product with markup no', { tags: 'Smoke' }, () => {
    ...
    customerestimates.yesMarkupChildNoProductNameFromFixture();
    customerestimates.yesMarkupChildNoProductPriceAssertion();
  });
  Cypress.on(
    'uncaught:exception',
    (_err, _runnable) =>
