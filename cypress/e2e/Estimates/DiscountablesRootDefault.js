...
describe('DiscountableRootDefault', () => {
  it('Adding a root product with discountable default', { tags: 'Smoke' }, () => {
    ...
    customerestimates.defaultDiscountableProductNameFromFixture();
    customerestimates.defaultDiscountableProductPriceAssertion();
  });
  Cypress.on(
    'uncaught:exception',
    (_err, _runnable) =>
