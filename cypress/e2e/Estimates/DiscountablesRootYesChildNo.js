...
describe('DiscountableRootYesChildNo', () => {
  it('Adding a child product with discountable no under root yes', { tags: 'Smoke' }, () => {
    ...
    customerestimates.yesDiscountableChildNoProductNameFromFixture();
    customerestimates.yesDiscountableChildNoProductPriceAssertion();
  });
  Cypress.on(
    'uncaught:exception',
    (_err, _runnable) =>
